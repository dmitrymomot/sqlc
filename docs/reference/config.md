...
- `db_type`:
  - The PostgreSQL type to override. Find the full list of supported types in [postgresql_type.go](https://github.com/dmitrymomot/sqlc/blob/master/internal/codegen/golang/postgresql_type.go#L12).
- `go_type`:
